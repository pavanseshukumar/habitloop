/**
 * Habit Loop by day: ink on warm paper.
 *
 * This is the original palette, unchanged. Every value here has been through
 * several visual passes, so dark mode was added beside it rather than by
 * touching it -- the light theme is the reference the dark one answers to.
 *
 * The three colours that carry the product, and what each one means:
 *
...
/**
 * Depth by day: two elevations, tinted with the brand blue so a lifted surface
 * reads as warm depth rather than grey haze.
 */
